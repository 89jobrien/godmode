...
description: >
  ...
  "what should I work on next" questions, any actionable mention ("we need to fix X", "TODO:
  add Y"), requests to review session progress, and requests to sync tasks with doob. See "When
