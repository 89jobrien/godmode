...
description: >
  ...
  user wants to go from idea → plan → tasks → code. Delegates to gm-tasks, gm-plans,
  and gm-tdd as the work progresses. Triggers on "plan this", "what should we build",
  "turn this into tasks", "start a new feature", or any request spanning design through
  implementation.
model: inherit
color: blue
tools:
