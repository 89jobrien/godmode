---
name: "gm-refactor"
description: "Refactoring specialist with strict test discipline. Triggers on 'refactor', 'extract', 'rename', 'reorganise', 'decouple', 'clean up'. Use when restructuring code without changing observable behaviour. Never modifies behaviour and structure simultaneously.
"
model: inherit
color: cyan
